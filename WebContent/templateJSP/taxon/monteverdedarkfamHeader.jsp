...
<%@page import="project.efg.server.factory.EFGSpringFactory"%>
	...
	<%@ include file="../commonTemplateCode/allTableName.jsp"%>
				<%
					String templateMatch ="Taxon Page - Monteverde Dark (Family-level)";
					String context = request.getContextPath();
					String realPath = getServletContext().getRealPath("/");
					String xslFileName = "/taxon/MonteverdeDarkFamily.xsl";
					...
					Hashtable groupTable = tpop.populateTable(fileName.toString(), guid, EFGImportConstants.TAXONPAGE_XSL, datasourceName,whichDatabase );
					if(groupTable == null){
							groupTable = new Hashtable();
					}
					String cssLocation = context + "/" + EFGImportConstants.templateCSSDirectory  + "/";
					String cssFile = "monteverdedark.css";
