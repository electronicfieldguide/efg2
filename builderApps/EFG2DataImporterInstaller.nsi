...
Function startDataImporter
    ClearErrors
    MessageBox MB_OK "About to Launch EFG2 Data Importer.$\r$\n\
    Your user name is root and your password is$\r$\n \
    the one you chose while installing MySQL."
...
Section /o un.Main UNSEC0000
    ;read the Tomcat home from registry
