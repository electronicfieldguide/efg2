...
!define EFG2_HOME "..\..\EFGsoftware\efg2"
...
!define PRODUCT_SUB_VERSION ".1"
!define RELEASE_NOTES_1_0_0_1 releaseNotes_1_0_0_1.html
!define EFG2_RELEASE_NOTES ${EFG2_HOME}\${RELEASE_NOTES_1_0_0_1}
...
!define MUI_FINISHPAGE_SHOWREADME $INSTDIR\${RELEASE_NOTES_1_0_0_1}
...
OutFile "${EFG2_HOME}\EFG2InstallerFull1_0_0_1.exe"
...
Section ""
    ...
    ;rdbImport.jar
    ;rdbProperties.properties
   
    ;class files in export ZipExport.class
   ;new help file
    ...
    File ${EFG2_HOME}\${EFG2_RELEASE_NOTES}
    ${LogText} "Copied ${EFG2_HOME}\${EFG2_RELEASE_NOTES}" 
...
Function CopyWebApps
   ...
   ReadRegStr $3 HKLM "${TOMCAT_KEY}" "InstallPath"
    ...
    SetOverwrite on
    File /r ${EFG2_LOCAL_RESOURCE_PATH}\efg2\ZipExport.class
    ${LogText} "Copied efg2 to 'Web application'"
