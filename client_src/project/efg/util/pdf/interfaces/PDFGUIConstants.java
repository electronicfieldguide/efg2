...
public interface PDFGUIConstants {
	//TODO read from spring file
	float LINE_SPACING_CONSTANT = 1.25f;
	float TAXONOMY_LINE_WEIGHT=3f;
	float TAXONOMY_LINE_SEP_WEIGHT=1f;
...
//	Title settings
	...
	String SUB_TITLE="subtitles";
	String FRONT_PAGE_TITLES="frontpagetitles";
	String FRONT_PAGE_SUBTITLES="frontpagesubtitles";
	String CREDITS1_TEXT = "credits1";
	String CREDITS2_TEXT = "credits2";
