 ...
 * @see #TypePage.jsp
 */
public class EFGDSHelperFactory implements EFGDSHelperFactoryInterface, Serializable
{
    private EFGDataSourceHelper dsHelper;

    /**
     * Empty constructor.
     */
    public EFGDSHelperFactory() {}

    /**
     * Create a EFGDataSourceHelper object to help working with multiple
     * data sources.
     */
    public void setDataSourceHelper()
    {
	dsHelper = new RDBDataSourceHelper();
    }
     ...
     */
    public EFGDataSourceHelper getDataSourceHelper()
    {
	setDataSourceHelper();
	return dsHelper;
    }
