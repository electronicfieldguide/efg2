...
/**
 * This class create a SAX handler to parse a xml document created by
 * filemaker.
 */
public class EFGParserHandler extends DefaultHandler 
{
	...
	if(_type == 0) {
	    ...
	    log.debug("In char, index is " + _recordIndex + ", value is " + _record[_recordIndex]);
	}
    ...
    {
	log.debug("Recoverable error on line " + 
