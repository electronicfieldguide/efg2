...
<html>
  ...
  <body bgcolor="#ffffff">
    <h2 align="center">Configure Search results page for a datasource</h2>
  <center>
      ...
      <table>
		  ...
		  <tr>
			 <td>
				...
				<a  title="click to configure search results page for the datasource" href="<%=context%>/SearchPageTemplate.jsp?dataSourceName=<%=URLEncoder.encode(dsName)%>">
