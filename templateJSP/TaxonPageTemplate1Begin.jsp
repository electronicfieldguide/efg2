...
<%
		...
		%>
<body>
<form method="post" action="<%=context%>/configTaxonPage"><input
	type="hidden" name="<%=groupLabel%>" value="<%=groupLabelValue%>" /> <input
	type="hidden" name="<%=name%>" value="<%=fieldValue%>" /> <%
...
<table class="title">
	<tr>
		<td class="comname" colspan="2"><select name="<%=name%>"
 ...
 %>
		...
		<table class="credits">
			<tr>
				...
				%> <input type="hidden" name="<%=groupLabel%>"
					value="<%=groupLabelValue%>" /> <strong>Credits: </strong><input
					size="100" type="text" title="ENTER CREDIT INFORMATION"
					name="<%=name%>" value="<%=fieldValue%>" /> <input type="hidden"
					name="<%=characterLabel%>" value="<%=characterLabelValue%>" /></p>
				</td>
			</tr>
		</table>
		</td>
