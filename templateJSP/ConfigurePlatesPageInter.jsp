  	...
  	<center>
  		<form name="configure" action="Redirect2Template.jsp">
      		...
      		<select name="<%=EFGImportConstants.TEMPLATE_NAME%>" title="Select a datasource from list below">
				<option value="commonNamePlateBegin.jsp">Plate Template1</option>
				<option value="mimicPlateBegin.jsp">Plate Template2</option>
				<option value="morningGloriesTemplatePlateBegin.jsp">Plate Template3</option>
    		</select>
