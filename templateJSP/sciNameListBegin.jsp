...
<html>
	...
	<%@ include file="jspName.jsp" %>
		...
		<%
			...
			if(displayName == null){
				displayName = (String)request.getParameter(EFGImportConstants.DISPLAY_NAME);
			}
			if(uniqueName == null){
				uniqueName =(String)request.getParameter(EFGImportConstants.TEMPLATE_UNIQUE_NAME); 
			}
			if(guid == null){
				guid =(String)request.getParameter(EFGImportConstants.GUID); 
			}
