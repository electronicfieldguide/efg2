...
set CP=%CLASSPATH%
set POINT=.
set CP=%XALAN_JAR%;%XML_APIS%;%XERCES_JAR%;%OSCACHE%;%SERVLET_JAR%;%CASTOR%;%LOG4J%;%common_logs%;%COMMON_IO%;%common_codec%;%IMPORT_JAR%;%CD%;%POINT%;%MYSQL_DRIVER%;%SPRING%;%ROWSET%;%OSTER_JAR%;properties;%SPRING_CONFIG_HOME%;%CP%
set CLASSPATH=%CP%
