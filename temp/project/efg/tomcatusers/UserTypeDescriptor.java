...
public class UserTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public UserTypeDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- _roles
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_roles", "roles", org.exolab.castor.xml.NodeType.Attribute);
        desc.setImmutable(true);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    UserType target = (UserType) object;
                    target.setRoles( (java.lang.String) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
    ...
    } //-- project.efg.tomcatusers.UserTypeDescriptor()
    ...
    {
        return project.efg.tomcatusers.UserType.class;
