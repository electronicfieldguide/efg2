...
public class EFGDialogLayout implements LayoutManager {
	...
	public EFGDialogLayout(){
		
	}
	public EFGDialogLayout(int hGap, int vGap) {
		m_hGap = hGap;
		m_vGap = vGap;
	}
	...
	public Dimension preferredLayoutSize(Container parent) {
		...
		return new Dimension(w + insets.left + insets.right, h + insets.top
				+ insets.bottom);
	}
