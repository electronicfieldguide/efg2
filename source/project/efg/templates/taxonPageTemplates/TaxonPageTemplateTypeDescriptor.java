...
/**
 * Class TaxonPageTemplateTypeDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class TaxonPageTemplateTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public TaxonPageTemplateTypeDescriptor() {
        super();
        xmlName = "taxonPageTemplateType";
        ...
        desc.setValidator(fieldValidator);
    } //-- project.efg.templates.taxonPageTemplates.TaxonPageTemplateTypeDescriptor()
    ...
    {
        return project.efg.templates.taxonPageTemplates.TaxonPageTemplateType.class;
