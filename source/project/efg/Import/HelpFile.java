 ...
 * @version 1.0
 */
public class HelpFile extends JDialog{
    private JEditorPane jep;
    
    public HelpFile(JFrame frame, String startingUrl) {
	// Ok, first just get a screen up and visible, with an appropriate
	// handler in place for the kill window command.
	super(frame,startingUrl,false);
	setSize(400,300);
	...
	JComponent newContentPane = this.addPanel(startingUrl);
	setContentPane(newContentPane);
    }
    private JPanel addPanel(String startingUrl){
