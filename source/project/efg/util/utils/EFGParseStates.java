/**
 * $Id: EFGParseStates.java,v 1.1.1.1 2007/08/01 19:11:27 kasiedu Exp $
 * $Name:  $
 *
...
public class EFGParseStates {
	 ...
	 * 
	 */
	public EFGParseStates() {
		this.filter = SpringFactory.getUnicode2Ascii();
	}
	...
	private  EFGParseObject checkForOperator(EFGParseObject parseObject){
		if(parseObject == null){
			...
			//do ranges
			OperatorInterface operator = SpringFactory.getOperatorInstance(parseObject.getState());
	...
	public  EFGParseObjectList parseStates(String separator,
		...
		EFGParseObjectList lists = SpringFactory.getParseObjectList();
		String[] fields = parse(separator,states);
