...
public class EFGParseObjectFactoryImpl implements EFGParseObjectFactory {
	...
	public MediaResourcesType createMediaResources(EFGParseObjectList objLists){
		...
		while(iter.hasNext()){
			...
			if(efgType != null){
				...
				mtype.setAnnotation(efgType.getAnnotation());
				mtype.setContent(efgType.getContent());
				mtype.setCaption(efgType.getAnnotation());
				mtype.setEfgKeyRef(efgType.getEfgKeyRef());
				mtype.setResourceLink(efgType.getResourceLink());
	...
	private EFGType createEFGType(String state, 
		...
		efgType.setAnnotation(annotation);
		efgType.setResourceLink(resourceLink);
	...
	private StatisticalMeasureType createStatisticalMeasureType(
		...
		stats.setAnnotation(annotation);
		stats.setCaption(caption);
