...
/**
 * $Id: EFGListTypeSorter.java,v 1.1.1.1 2007/08/01 19:11:25 kasiedu Exp $
 * $Name:  $
 * 
...
public class EFGListTypeSorter implements EFGDocumentSorter{
 ...
 private EFGListsType efgType;
 
 	public EFGListTypeSorter(){
	...
	public void sort(Comparator compare,Object sorter) {
		this.efgType = (EFGListsType)sorter;
