...
/**
 * $Id: MediaResourceTypeSorter.java,v 1.1.1.1 2007/08/01 19:11:26 kasiedu Exp $
 * $Name:  $
 * 
...
public class MediaResourceTypeSorter implements EFGDocumentSorter{
 ...
 private MediaResourcesType efgType;
 
 	public MediaResourceTypeSorter(){
	...
	public void sort(Comparator compare,Object sorter) {
		this.efgType = (MediaResourcesType)sorter;
