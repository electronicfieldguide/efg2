/**
 * $Id: ExportEFG.java,v 1.1.1.1 2007/08/01 19:11:24 kasiedu Exp $
 *
...
public class ExportEFG extends HttpServlet implements EFGImportConstants {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		try {
			log = Logger.getLogger(project.efg.server.servlets.ExportEFG.class);
		} catch (Exception ee) {
		}
	...
	private String exportFiles(String[] datasources,String[] glossaries,String[] mediaresources,String[] otherResources, String context) {
		try {
			...
			File exportDirectory = new File(realPath,
				...
				ZipExport zip =EFGSpringFactory.getZipExportInstance();
				
				String zipFileName = zip.zipExports(
							serverDirectory,
							exportDirectory,
							ds, 
							mediaresources, 
