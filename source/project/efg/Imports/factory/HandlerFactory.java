...
import project.efg.Imports.efgImpl.SynopticKeyTransferHandler;
import project.efg.Imports.efgImpl.TreeExpansionHandler;
...
public class HandlerFactory {
	...
	public static synchronized TransferHandler getTransferHandler(){
		return new SynopticKeyTransferHandler();
	}
