 ...
 */
public class LoginModule extends 
project.efg.Imports.efgInterface.LoginAbstractModule {
	...
	public  boolean login(DBObject dbObject) {
		try {
			JdbcTemplate template =
				project.efg.Imports.rdb.EFGRDBImportUtils.getJDBCTemplate(dbObject);
			if(template == null){
