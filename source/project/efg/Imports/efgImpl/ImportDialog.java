...
import project.efg.Imports.factory.ImportCommandFactory;
...
public class ImportDialog extends JDialog {
	...
	private JPanel createSimpleDialogBox() {
		...
		radioButtons[0].setActionCommand(importOnlyCommand);
		radioButtons[0]
		...
		radioButtons[1].setActionCommand(importUseMetadataCommand);
		radioButtons[1]
