...
public class AutofitTableColumns
{
    ...
    public static Dimension autoResizeTable ( JTable aTable, boolean includeColumnHeaderWidth )
    {
     ...
     * @returns The table width, just in case the caller wants it...
     */
    public static Dimension autoResizeTable ( JTable aTable, boolean includeColumnHeaderWidth, int columnPadding )
    {
