/* $Id: EFGDatasourcesList.java,v 1.1.1.1 2007/08/01 19:11:19 kasiedu Exp $
* $Name:  $
...
public class EFGDatasourcesList extends EFGDatasourceObjectListInterface {
	...
	/* (non-Javadoc)
	 * @see project.efg.Imports.efgInterface.EFGDatasourceObjectListInterface#removeEFGDatasourceObject(project.efg.util.interfaces.EFGDatasourceObjectInterface)
	 */
	...
	/* (non-Javadoc)
	 * @see project.efg.Imports.efgInterface.EFGDatasourceObjectListInterface#addEFGDatasourceObject(project.efg.util.interfaces.EFGDatasourceObjectInterface, boolean)
	 */
