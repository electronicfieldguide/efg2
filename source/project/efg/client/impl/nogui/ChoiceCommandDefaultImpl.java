/**
 * $Id: ChoiceCommandDefaultImpl.java,v 1.1.1.1 2007/08/01 19:11:16 kasiedu Exp $
 * $Name:  $
 * 
 ...
 *
 */
public class ChoiceCommandDefaultImpl extends ChoiceCommandAbstract {

	/**
	 * 
	 */
	public ChoiceCommandDefaultImpl() {
		super();
	...
	createImportBehavior(EFGDatasourceObjectListInterface lists,
