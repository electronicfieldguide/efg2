/**
 * $Id: ChoiceCommandUpdateImpl.java,v 1.1.1.1 2007/08/01 19:11:16 kasiedu Exp $
 * $Name:  $
 * 
 ...
 *
 */
public class ChoiceCommandUpdateImpl extends ChoiceCommandAbstract {
	static Logger log;
	static {
		try {
			log = Logger.getLogger(ChoiceCommandUpdateImpl.class);
		} catch (Exception ee) {
		}
	}
	/**
	 * 
	 */
	public ChoiceCommandUpdateImpl() {
		super();
	...
	public ImportBehavior createImportBehavior(
		...
		String behaviorType =
			...
			getProperty("importUpdateBehavior");
		log.debug("BehaviorType: " + behaviorType);
			return GUIFactory.getImportBehavior(
				lists,
				obj, 
				behaviorType
				);
