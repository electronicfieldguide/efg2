/**
 * $Id: RunSetUp.java,v 1.1.1.1 2007/08/01 19:11:17 kasiedu Exp $
 *
...
public class RunSetUp {
	 ...
	 * @return
	 */
	private static boolean createASuperUser(DBObject db, 
	...
	public  static Object[] getEFGUsers(DBObject db) {
		try{
			...
			List list = 
				jdbcTemplate.queryForList(queryBuffer.toString(), String.class);
			if(list != null){
