...
<%
	...
	String queryResults = "Query results: " + fieldValue;
...
%>
 <form method="post" action="<%=context%>/configTaxonPage" onsubmit="return validateForm();">
	...
	<tr>
		...
		%>
			...
			%>
 				...
 				<input id="imageframecolor1id" style="position: absolute; right: 15px; top: 239px;" size="8" name="<%=name%>" class="color"  value="<%=fieldValue%>" type="text"/>
 				...
 				<span>
					...
					if(characterLabelValue == null){
						characterLabelValue ="boundingboxcolor";
	 					...
	 					<input id="boundingboxcolor1id" style="position: absolute; right: 15px; top: 239px;" size="8" name="<%=name%>" class="color" value="<%=fieldValue%>" type="text">
						<input type="hidden"    name="<%=characterLabel%>" value="<%=characterLabelValue%>"/> 												
 				</span>
 			</span>
		 </td>
	...
	<tr>
		<td class="formitem" colspan="2">Fill space around disproportionate images? 
			...
			if(characterLabelValue == null){
				...
				<input type="hidden" name="<%=characterLabel%>" value="<%=characterLabelValue%>"/> 												
				<input id="boundingboxcolor2id" style="position: absolute; right: 15px; top: 239px;" size="8" name="<%=name%>" class="color" value="<%=fieldValue%>" type="text"/>				
			</td>
		</tr>
	</table>
